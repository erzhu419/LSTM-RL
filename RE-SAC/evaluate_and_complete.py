...
# BASELINE_DIR = "RE-SAC/logs/sac_v2_bus_sigma1p5_embed-full_wreg0p0_exp_sac_amax2p0_20251025_221923"
...
OUTPUT_IMG = 'RE-SAC/best_ensemble_vs_baseline_evaluated.png'
TARGET_EPISODES = 500
START_EPISODE = 465
...
def main():
    ...
    # Initialize Env
    # Use RE-SAC/env_original path
    
    env = sim.env_bus(path='RE-SAC/env_original', route_sigma=ARGS['route_sigma']) 
    ...
    debug_path = 'RE-SAC/full_rewards_debug.npy'
    ...
    original_log_path = 'RE-SAC/logs_ensemble_original/wr0.01_a0.6_r2_buf1000000.log'
    original_rewards = []
    import re
    ...
    np.save('RE-SAC/full_rewards_debug.npy', full_arr)
