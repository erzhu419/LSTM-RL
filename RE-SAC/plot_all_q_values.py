...
experiments = {
    ...
    # "RE-SAC/ensemble_2/logs": ("Ensemble 2", "#1f77b4", "-", "q_values_episode.npy", "q_stds_episode.npy"),
    "RE-SAC/ensemble_5/logs": ("Ensemble 5", "#ff7f0e", "-", "q_values_episode.npy", "q_stds_episode.npy"),
    "RE-SAC/ensemble_10/logs": ("Ensemble 10", "#2ca02c", "-", "q_values_episode.npy", "q_stds_episode.npy"),
    "RE-SAC/ensemble_20/logs": ("Ensemble 20", "#d62728", "-", "q_values_episode.npy", "q_stds_episode.npy"),
    "RE-SAC/ensemble_40/logs": ("Ensemble 40", "#9467bd", "-", "q_values_episode.npy", "q_stds_episode.npy"),
    "RE-SAC/Aleatoric_Only/logs": ("Aleatoric Only", "#8c564b", "--", "q_values_episode.npy", "q_stds_episode.npy"),
    # "RE-SAC/Epistemic_Only/logs": ("Epistemic Only", "#e377c2", "--", "q_values_episode.npy", "q_stds_episode.npy"),
}

OUTPUT_FILE = "RE-SAC/all_q_values_comparison.png"
