...
experiments = {
    ...
    "RE-SAC/ensemble_2/logs": ("Ensemble 2", "#1f77b4", "-"),   # Blue
    "RE-SAC/ensemble_5/logs": ("Ensemble 5", "#ff7f0e", "-"),   # Orange
    "RE-SAC/ensemble_10/logs": ("Ensemble 10", "#2ca02c", "-"),  # Green
    "RE-SAC/ensemble_20/logs": ("Ensemble 20", "#d62728", "-"),  # Red
    "RE-SAC/ensemble_40/logs": ("Ensemble 40", "#9467bd", "-"),  # Purple
    "RE-SAC/Aleatoric_Only/logs": ("Aleatoric Only", "#8c564b", "--"), # Brown, Dashed
    "RE-SAC/Epistemic_Only/logs": ("Epistemic Only", "#e377c2", "--"), # Pink, Dashed
}

OUTPUT_FILE = "RE-SAC/all_experiments_comparison.png"
