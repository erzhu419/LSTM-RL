...
experiments = {
    ...
    os.path.join(BASE_DIR, "ensemble_paper/ensemble_2/logs"): ("Ensemble 2", "#1f77b4", "-", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/ensemble_5/logs"): ("Ensemble 5", "#ff7f0e", "-", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/ensemble_10/logs"): ("Ensemble 10", "#2ca02c", "-", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/ensemble_20/logs"): ("Ensemble 20", "#d62728", "-", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/ensemble_40/logs"): ("Ensemble 40", "#9467bd", "-", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/Aleatoric_Only/logs"): ("Aleatoric Only", "#8c564b", "--", "npy"),
    os.path.join(BASE_DIR, "ensemble_paper/Epistemic_Only/logs"): ("Epistemic Only", "#e377c2", "--", "npy"),
    # New DSAC versions
    os.path.join(BASE_DIR, "ensemble_paper/full_rewards_debug.npy"): ("DSAC-v1", "#00ced1", "-.", "npy_direct"), # DarkTurquoise
    os.path.join(BASE_DIR, "ensemble_paper/logs_bac/logs/bac_v1_lambda0p5_q0p7"): ("BAC", "#9400D3", ":", "npy"), # DarkViolet
}

OUTPUT_FILE = os.path.join(BASE_DIR, "ensemble_paper/all_experiments_comparison_v2.png")
