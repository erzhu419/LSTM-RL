...
if __name__ == "__main__":
    ...
    parser.add_argument('--results_path', type=str, default='/home/erzhu419/mine_code/LSTM-RL/ensemble_paper/comparasion_q/results/q_comparison_results.npy')
    parser.add_argument('--save_dir', type=str, default='/home/erzhu419/mine_code/LSTM-RL/ensemble_paper/comparasion_q/pic')
