...
def main():
    ...
    parser.add_argument('--ensemble_dir', type=str, default='/home/erzhu419/mine_code/LSTM-RL/ensemble_paper/ensemble_10/model')
    parser.add_argument('--vanilla_dir', type=str, default='/home/erzhu419/mine_code/LSTM-RL/第一篇论文的模型和图/sac_v2_bus')
    parser.add_argument('--save_dir', type=str, default='/home/erzhu419/mine_code/LSTM-RL/ensemble_paper/comparasion_q/results')
